...
public class XBoxController extends Joystick{
	// Instance values
		...
		private void initInputSources() {
			a = addButton(RobotMap.BUTTON_A);
			b = addButton(RobotMap.BUTTON_B);
			x = addButton(RobotMap.BUTTON_X);
			y = addButton(RobotMap.BUTTON_Y);
			shoulderLeft = addButton(RobotMap.BUTTON_SHOULDER_LEFT);
			shoulderRight = addButton(RobotMap.BUTTON_SHOULDER_RIGHT);
			back = addButton(RobotMap.BUTTON_BACK);
		...
		public double getLeftX() {
			return getRawAxis(RobotMap.XBOX_LEFT_X);
		}
		...
		public double getLeftY() {
			return getRawAxis(RobotMap.XBOX_LEFT_Y);
		}
		...
		public double getRightX() {
			return getRawAxis(RobotMap.XBOX_RIGHT_X);
		}
		...
		public double getRightY() {
			return getRawAxis(RobotMap.XBOX_RIGHT_Y);
		}
		...
		public double getLeftTriggerAxis() {
			return getRawAxis(RobotMap.XBOX_LEFT_TRIGGER);
		}
		...
		public double getRightTriggerAxis() {
			return getRawAxis(RobotMap.XBOX_RIGHT_TRIGGER);
		}
